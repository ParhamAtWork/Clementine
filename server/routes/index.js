...
app.post('/Users', (req, res) => {
  ...
  const query = 'INSERT INTO Users (UserID, UserType, Username, PasswordHash, Email) VALUES (?, ?, ?, ?, ?)';
  con.query(query, [UserID, UserType, Username, PasswordHash, Email], function(err) {
    if (!err) {
...
app.put('/Users/:id', (req, res) => {
  ...
  const query = 'UPDATE Users SET UserType = ?, Username = ?, PasswordHash = ?, Email = ? WHERE UserID = ?';
  con.query(query, [UserType, Username, PasswordHash, Email, UserID], function(err) {
    if (!err) {
...
app.post('/PaymentHistory', (req, res) => {
  ...
  const query = 'INSERT INTO PaymentHistory (PaymentID, TransactionID, Status, ReceiptURL) VALUES (?, ?, ?, ?)';
  con.query(query, [PaymentID, TransactionID, Status, ReceiptURL], function(err) {
    if (!err) {
...
app.put('/PaymentHistory/:id', (req, res) => {
  ...
  const query = 'UPDATE PaymentHistory SET TransactionID = ?, Status = ?, ReceiptURL = ? WHERE PaymentID = ?';
  con.query(query, [TransactionID, Status, ReceiptURL, PaymentID], function(err) {
    if (!err) {

...
import { BellIcon, ScaleIcon, XMarkIcon } from '@heroicons/react/24/outline';
import {
	BanknotesIcon,
	BuildingOfficeIcon,
	CheckCircleIcon,
			...
			<div className='min-h-full'>
				...
				<div className='flex justify-between '>
					<div className='ml-4 flex items-center'>
						<button
							type='button'
							className='relative rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 ç focus:ring-offset-2'
						>
						...
						>
							{/* TODO Ring color */}
							<div>
								<Menu.Button className='relative flex max-w-xs items-center rounded-full bg-white text-sm focus:ring-2 focus:ring-offset-2 lg:rounded-md lg:p-2 lg:hover:bg-gray-50'>
							...
							>
								<Menu.Items className='absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-stone py-1 shadow-lg ring-1 ring-[#000] ring-opacity-5 focus:outline-none'>
									<Menu.Item>
										{({ active }) => (
											<a
												href='#'

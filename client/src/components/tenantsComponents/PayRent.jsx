					...
					<div className='bottom-0 flex-none border-gray-200 bg-gray-50 p-6'>
						...
						<dl className='mt-4 space-y-2 text-sm font-medium text-gray-500'>
							...
							<button
								...
								className='mt-6 w-full rounded-md border border-transparent bg-[#558540] px-4 py-2 text-md font-medium text-[#fff] shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
							>
								{paymentAmount &&
								!isNaN(paymentAmount) &&
